...
class FaceDetector( ):
    ...
    def detect( self, frame ):
        ...
        smallFrame = cv2.resize(frame,None,fx=FaceDetector.SCALE, fy=FaceDetector.SCALE, interpolation = cv2.INTER_LINEAR)
        ...
        minSize = int(smallFrame.shape[1] * FaceDetector.MIN_FACE_FRAME_PERCENT)
